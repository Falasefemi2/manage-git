    ...
    public static void main(String[] args) {
        ...
        while (!exit) {
            ...
            switch (choice) {
                ...
                case 2 -> System.out.println("Viewing profile...");
                case 3 -> System.out.println("Listing repositories...");
                case 4 -> System.out.println("Creating repository...");
                case 5 -> System.out.println("Deleting repository...");
                case 6 -> System.out.println("Updating bio...");
